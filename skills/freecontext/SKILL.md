...
- Read this skill alone: never batch that read with Git, file listing, search, source/document reads, or other task work. Make `gather_context` the next tool action after this body is available.
