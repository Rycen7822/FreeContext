...
import type { ResolvedWorkspaceEntry, Workspace, WorkspaceEntryKind } from "./contracts.js";
...
export function assertDirectFileSize(
  target: ResolvedWorkspaceEntry,
...
export async function createWorkspace(rootInput?: string): Promise<Readonly<Workspace>> {
  ...
  async function resolveExisting(
    ...
    }: Readonly<{ kind?: WorkspaceEntryKind; allowSensitive?: boolean }> = {},
  ): Promise<Readonly<ResolvedWorkspaceEntry>> {
