...
export function createJqTool({ Type, workspace, semaphore, config, executable }: ExternalToolContext) {
  ...
  const tool: AgentTool<typeof parameters, JqToolDetails> = {
    name: "jq",
