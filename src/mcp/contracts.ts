...
export const TOOL_DESCRIPTION = [
  ...
  "Returns ordinary assistant text with supported facts, observed path:line locations plus function or symbol, applicable conditions, and a short excerpt when needed. Treat supported facts and conditions as already-read context; do not reread every listed file to confirm the answer. Check exact edit locations, gaps, contradictions, and new design/test premises narrowly. Any FC design suggestion is not a verified conclusion. Delegate a new substantial unknown when useful during work; no failed test, new module, or call count is required.",
