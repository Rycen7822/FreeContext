...
export const TOOL_DESCRIPTION = [
  ...
  "At any phase, delegate one unresolved fact or relationship whose answer can replace substantial new reading. Stay native if the small edit-context read Main needs anyway can settle it. Do not finish the investigation before delegating, request a recap of already-read code, or call routinely at task start. Keep overall diagnosis, design, edits, tests, and local fixes in Main.",
  "FC sees only question and hints: include the original operation and semantics to preserve, checked facts, and the unknown; label proposals and unverified assumptions. Ask for a specific relationship, not a feature design or full audit.",
  "Returns ordinary assistant text with supported facts, observed path:line locations plus function or symbol, and applicable conditions, plus a short excerpt when needed. Treat supported facts as already-read context; check exact edit locations, missing or contradictory evidence, and new design/test premises narrowly. New cross-boundary questions may arise during work on the same feature; no failed test, new module, or call count is required.",
