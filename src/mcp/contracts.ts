...
export const TOOL_DESCRIPTION = [
  ...
  "Use when filtering can replace most reading, not merely because output is long; read core exact-edit code and small dense output natively. No call is required. Ask for observable facts, paths, source lines, errors and excerpts in this capture, not global absence judgments or design review.",
